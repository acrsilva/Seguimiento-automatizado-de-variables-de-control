...
class PanelSueno():
    ...
    def plotGraph(self, fig, filtro, despierto, profundo):
        ...
        axTemperatura.set_ylim([self.selep.csv.cotas.temp_min, self.selep.csv.cotas.temp_max])
        fig.autofmt_xdate()
        ...
        axFlujo.set_ylim([self.selep.csv.cotas.flujo_min, self.selep.csv.cotas.flujo_max])
        fig.autofmt_xdate()
        xfmt = md.DateFormatter('%H:%M')
        ...
        axConsumo.set_ylim([self.selep.csv.cotas.consm_min, self.selep.csv.cotas.consm_max])
        fig.autofmt_xdate()
        xfmt = md.DateFormatter('%H:%M')
